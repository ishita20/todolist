...
const getPlaces = require('./test_maps');
...
const watcher = navigator.geolocation.watchPosition(displayLocationInfo, error, {distanceFilter:1500});
setTimeout(() => {
...
function displayLocationInfo(position) {
    ...
    getPlaces.fetchAll(position.coords.latitude, position.coords.longitude)
...
showList();
},{"./test_maps":7}],2:[function(require,module,exports){
...
//fetchAll()
},{"es6-promise":3,"isomorphic-fetch":4,"perf_hooks":2}]},{},[1,7]);
